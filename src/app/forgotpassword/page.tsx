...
function Forgotpassword() {
  ...
  return (
<Form classname='w-full px-2 pt-[115px] min-h-screen flex items-center place-content-center' onsubmit={resetemail}>
    ...
    <div className='w-full md:w-[50%] h-full px-2 flex flex-col items-center place-content-center '>
        ...
        <button type="submit" className='bg-blue-600 w-[130px] py-1 text-white mt-4 font-bold'>Send link</button>
    </div>
    </div>
 </Form>
  )
