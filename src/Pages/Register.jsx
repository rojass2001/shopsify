...
<div className='w-full px-2 pt-[115px] min-h-screen flex items-center place-content-center'>
  <form className='w-full pb-8 md:pb-0 md:w-[60%] shadow-md h-auto md:h-[400px] flex flex-col md:flex-row  gap-5 bg-white shadow-gray-300'>
     <div className='w-full md:w-[50%] py-4 rounded-b-[20%] md:rounded-b-[0%] text-white flex flex-col gap-5 bg-blue-600  place-content-center place-items-center h-full'>
      ...
      <Link to="/login"><button className='border-[1px] px-8 py-1 border-white'>Login</button></Link>
    </div>
    ...
    <div className='w-full md:w-[50%] h-full px-2 flex flex-col items-center place-content-center '>
      ...
      <MdEmail /> <input required className='outline-none w-full h-12 pl-2' placeholder='enter email' type="email"/>
      </span>
      <span className={`${inputcontainer} mt-5`}>
      <FaLock className="text-sm" /> <input required  className='outline-none w-full h-12 bg-white pl-2' placeholder='enter password' type="password"/>
      </span>
      <button type="submit" className='bg-blue-600 w-[130px] py-1 text-white mt-4 font-bold'>Register</button>
     </div>
 </form>
</div>
  )
