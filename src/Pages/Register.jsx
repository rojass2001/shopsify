...
function Register() {
  ...
  <div className='w-full md:w-[50%] py-4 rounded-b-[20%] md:rounded-b-[0%] text-white flex flex-col gap-5 bg-blue-600
    place-content-center place-items-center h-[30%] md:h-full'>
  ...
  <div className='w-full md:w-[50%] h-[50%] md:h-full px-2 flex flex-col items-center place-content-center '>
    ...
    <button className='bg-blue-600 w-[130px] py-1 text-white font-bold'>Register</button>
  </div>
      </div>
    </div>
  )
