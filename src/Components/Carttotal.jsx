...
function Cartsubtotal() {
  ...
  <div className='w-full relative space-y-2 min-h-[200px]  text-blue-700 font-bold border-[4px]'>
    <div className='flex justify-between bg-blue-700 text-white w-full py-2' >Total Items:<span>{cartproducts.length}</span>
     ...
     <div className='flex w-full text-blue-700 p-2 font-extrabold justify-between'>Subtotal:<span>${totalprice}</span></div>
     <div className='flex w-full p-2 text-blue-700 font-extrabold justify-between  '>TotalPrice:<span>${totalprice}</span></div>
