...
function Tabbar() {
  ...
  <>
      {!isKeyboardOpen&&(
        <div className='w-full px-2 text-white h-[60px] pt-2 overflow-x-auto rounded-t-3xl flex justify-around items-center place-content-center fixed z-50 bottom-0 right-0 left-0  md:hidden ' style={{ backgroundColor: "blue" }}>
          <Link href="/">
